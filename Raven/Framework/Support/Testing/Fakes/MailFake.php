...
use Raven\Contracts\Mail\Mailer;
use Raven\Contracts\Mail\MailQueue;
use Raven\Contracts\Queue\ShouldQueue;
...
class MailFake implements Mailer, MailQueue
{
     ...
     * @param  \Raven\Contracts\Mail\Mailable|string|array  $view
     * @param  string  $queue
     * @return mixed
     */
