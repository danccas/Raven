 ...
 * @method static \Raven\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 ...
 * @method static bool hasValidSignature(\Raven\Http\Request $request, bool $absolute = true)
 * @method static void defaults(array $defaults)
 * @method static void forceScheme(string $scheme)
 *
 * @see \Raven\Routing\UrlGenerator
 */
