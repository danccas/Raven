...
use Raven\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \Raven\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static string getConnectionName()
 * @method static \Raven\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 *
 * @see \Raven\Queue\QueueManager
 * @see \Raven\Queue\Queue
 */
class Queue extends Facade
{
     ...
     *
     * @return \Raven\Support\Testing\Fakes\QueueFake
     */
