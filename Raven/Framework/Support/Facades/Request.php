 ...
 * @method static \Raven\Http\UploadedFile|\Raven\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static \Raven\Http\Request capture()
 * @method static \Raven\Http\Request instance()
 ...
 * @method static \Raven\Http\Request merge(array $input)
 * @method static \Raven\Http\Request replace(array $input)
 * @method static \Symfony\Component\HttpFoundation\ParameterBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \Raven\Http\Request createFrom(\Raven\Http\Request $from, \Raven\Http\Request|null $to = null)
 * @method static \Raven\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \Raven\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 * @method static mixed filterFiles(mixed $files)
 * @method static \Raven\Session\Store session()
 * @method static \Raven\Session\Store|null getSession()
 * @method static void setLaravelSession(\Raven\Contracts\Session\Session $session)
 * @method static mixed user(string|null $guard = null)
 * @method static \Raven\Routing\Route|object|string route(string|null $param = null, string|null $default = null)
 * @method static string fingerprint()
 * @method static \Raven\Http\Request setJson(\Symfony\Component\HttpFoundation\ParameterBag $json)
 * @method static \Closure getUserResolver()
 * @method static \Raven\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \Raven\Http\Request setRouteResolver(\Closure $callback)
